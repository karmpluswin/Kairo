...
export default function AnimeCard({
  ...
  return (
    <div className="w-full max-w-[500px]">
      <div className="flex flex-col min-[540px]:flex-row overflow-hidden rounded-xl border border-border bg-card text-card-foreground hover:border-green-500 transition-all ease-in-out w-[200px] mx-auto min-[540px]:w-full min-[540px]:mx-0 min-[540px]:h-[288px]">
...
/>
        ...
        <div className="flex flex-col flex-1 min-w-0 p-2 min-[540px]:p-4 min-[540px]:justify-between gap-2 border-t min-[540px]:border-t-0 border-border">
          {/* Title + stats — hidden only on narrow viewports */}
          <div className="hidden min-[540px]:flex flex-col flex-1 justify-between min-h-0">
          ...
          <div className="flex flex-col gap-2 min-[540px]:mt-auto">
            {showWatchingControl ? (
