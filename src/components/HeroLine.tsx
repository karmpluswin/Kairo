...
export function HeroLine() {
  ...
  return (
    <h2
      ...
      className="text-center font-semibold leading-none text-3xl max-w-sm xs:text-5xl xs:max-w-xl lg:text-7xl w-full lg:max-w-5xl p-4 pt-0 my-4 cursor-default select-none"
